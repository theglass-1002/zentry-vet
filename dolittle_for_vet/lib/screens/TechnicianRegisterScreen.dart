...
class TechnicianRegisterScreen extends StatefulWidget {
  ...
  //static const routeName = '/TechnicianRegisterScreen';
...
class _TechnicianRegisterScreenState
    extends State<TechnicianRegisterScreen> {
  ...
  Widget Contents(BuildContext buildContext) {
    return Scaffold(
      ...
      appBar: AppBar(
          elevation: 1,
          title: Text(
            "name_Technician registration".tr(),
          )),
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: "Technician license number".tr(),
            ),
